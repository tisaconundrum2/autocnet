...
_CONTROLPOINTFILEENTRYV0002_MEASURE_MEASURETYPE = descriptor.EnumDescriptor(
  name='MeasureType',
...
_CONTROLPOINTFILEENTRYV0002_POINTTYPE = descriptor.EnumDescriptor(
  name='PointType',
...
_CONTROLPOINTFILEENTRYV0002_APRIORISOURCE = descriptor.EnumDescriptor(
  name='AprioriSource',
...
_CONTROLNETFILEHEADERV0002 = descriptor.Descriptor(
...
_CONTROLPOINTFILEENTRYV0002_POINTLOGDATA = descriptor.Descriptor(
  name='PointLogData',
...
_CONTROLPOINTFILEENTRYV0002_MEASURE_MEASURELOGDATA = descriptor.Descriptor(
  name='MeasureLogData',
...
_CONTROLPOINTFILEENTRYV0002_MEASURE = descriptor.Descriptor(
  name='Measure',
...
_CONTROLPOINTFILEENTRYV0002 = descriptor.Descriptor(
...
class ControlNetFileHeaderV0002(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _CONTROLNETFILEHEADERV0002
  
  # @@protoc_insertion_point(class_scope:Isis.ControlNetFileHeaderV0002)

class ControlPointFileEntryV0002(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  
  class PointLogData(message.Message):
    __metaclass__ = reflection.GeneratedProtocolMessageType
  ...
  class Measure(message.Message):
    __metaclass__ = reflection.GeneratedProtocolMessageType
    
    class MeasureLogData(message.Message):
      __metaclass__ = reflection.GeneratedProtocolMessageType
